...
const Form = ({medList, prescript, createDate, isReadOnly}: FormProps) => {
    ...
    return (
        <form id="prescript-form">
            ...
            <div className="form-input">
                <label htmlFor="doses">Quantity #: </label>
                <input id="doses" type="number" onChange={handleInputChange} value={prescript?.quantity || formData.quantity} name="quantity" disabled={isReadOnly}/>
            </div>
